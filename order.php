...
if ($data['code'] == 'ok') {
    ...
    <div class="container">
        <h2 class="success-page__title">Complimenti! Il tuo ordine è stato accettato!</h2>

        <p class="success-page__message_success">Un operatore del nostro call center ti chiamerà a breve per confermare l'ordine. Assicurati che il tuo telefono sia acceso.</p>

        <h3 class="success-page__text">Controlla le informazioni che hai inserito</h3>

        <div class="list-info">
            <ul class="list-info__list">
                <li class="list-info__item">
                    <span class="list-info__text">Nome e Cognome.: </span>
                    $name
                </li>
                <li class="list-info__item">
                    <span class="list-info__text">Numero di telefono: </span>
                    $phone
                </li>
            </ul>
        </div>
        ...
        <p class="success-page__message_fail">
            <a class="success-page__message_fail__link" href="#" onclick="GoBackWithRefresh();return false;">
                Se hai sbagliato a compilare il modulo, torna indietro e compilalo di nuovo
            </a>
        </p>
    </div>
</div>
